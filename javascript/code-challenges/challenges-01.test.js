...
const addExclamation = (arr) => {
  // Solution code here...
  let newArr = [];
  arr.forEach(stringsy => newArr.push(stringsy + '!'));
  return newArr;
};
...
const allUpperCase = (arr) => {
  // Solution code here...
  let newArr = [];
  arr.forEach(stringsy => newArr.push(stringsy.toUpperCase()));
  return newArr;
};
...
const speaker = (words, callback) => {
  // Solution code here... (study this)
  let newArr = [];
  words.forEach(wtvr => newArr.push(callback(wtvr)));
  return newArr;
};
