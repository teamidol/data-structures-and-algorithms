...
const maxInArray = (arr) => {
  // Solution code here...
  let newArr = arr.reduce((acc, curVal) => {
...
const getCourseKeys = (obj) => {
  // Solution code here...
  // let newArr = [];
  // let keyOn = newArr.push(Object.keys(obj));
  // console.log(keyOn);
  // return newArr;
  let keyOnly = Object.keys(obj);
  return keyOnly;
};
...
const checkValues = (obj, value) => {
  // Solution code here...
  let truey = Object.values(obj);
  return truey.includes(value) ? true : false;
};
...
const updateNumbers = (obj) => {
  // Solution code here...
  let results = [];
  Object.keys(obj).forEach(num => results.push(`${num}: ${obj[num]}`));
  return results;
};
...
const getHouses = (arr) => {
  let houses = [];
  // Solution code here...
  Object.values(arr).forEach(num => houses.push(num.house));
  console.log(houses);
  return houses;
};
...
const hasChildrenValues = (arr, character) => {
  ...
  let children = 0;
  arr.forEach(num => {
    if (num.name === character){
      Object.keys(num).forEach((key, idx) => {
        if (key === 'children')
          children = Object.values(num)[idx].length;
